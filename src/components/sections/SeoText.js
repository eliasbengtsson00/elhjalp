    ...
    <section className="my-24 md:my-32 opacity-30 hover:opacity-100 transition-opacity duration-200">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-xs text-foreground-text font-light leading-relaxed">
            ...
            Vi finns listade i registret Kolla elföretaget för att du som kund ska kunna verifiera 
            vår behörighet och känna dig trygg i ditt val av elektriker.
          </p>
        </div>
      </div>
    </section>
